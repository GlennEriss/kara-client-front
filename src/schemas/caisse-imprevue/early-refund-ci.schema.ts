...
// Schema pour la demande de retrait anticipé CI
export const earlyRefundCISchema = z.object({
  ...
  // Montant retiré (obligatoire, positif)
  withdrawalAmount: z
...
export type EarlyRefundCIFormData = z.infer<typeof earlyRefundCISchema>

// Valeurs par défaut
export const defaultEarlyRefundCIValues: Partial<EarlyRefundCIFormData> = {
  reason: '',
