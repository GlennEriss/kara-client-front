...
import { approveDemandSchema } from '@/schemas/placement.schema'
...
export default function AcceptDemandModal({
  ...
  const { approve } = usePlacementDemandMutations()
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <ModalContent size="lg">
        <ModalHeader
          ...
          description="Vous êtes sur le point d'accepter cette demande de placement. Veuillez indiquer le motif d'acceptation."
        />
        ...
        <ModalBody className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-500">
              Expliquez pourquoi cette demande est acceptée (ex: bienfaiteur fiable, montant raisonnable...)
            </p>
          </div>
        </ModalBody>
