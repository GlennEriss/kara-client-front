...
import { useCommunes, useDepartments, useDistrictMutations, useProvinces } from '@/hooks/useGeographie'
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
              ...
              <DialogFooter>
                ...
                <Button type="submit" disabled={isSubmitting || !selectedCommuneId || !selectedCount || selectedCount < 1}>
                  {isSubmitting ? (
                    <>
