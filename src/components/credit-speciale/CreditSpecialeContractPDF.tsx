...
interface CreditSpecialeContractPDFProps {
  contract: CreditContract
  memberData?: any
  guarantorData?: any
}

const CreditSpecialeContractPDF = ({ contract, memberData, guarantorData }: CreditSpecialeContractPDFProps) => {
  ...
  const formatAmount = (amount: number) => {
    if (!amount) return '0'
    // Utiliser un espace normal au lieu de l'espace insécable de toLocaleString
  ...
  const member = {
    ...
    contacts: memberData?.contacts || contract.clientContacts || [],
  }
  ...
  return (
    <Document>
      {/* PAGE 1 - RECONNAISSANCE DE DETTE */}
        ...
        <View style={styles.headerSection}>
          ...
          <View style={styles.headerInfo}>
            <View style={styles.headerLine}>
              <Text style={styles.headerLabel}>NOM : </Text>
              <Text style={styles.headerValue}>{member.lastName.toUpperCase()}</Text>
            </View>
            <View style={styles.headerLine}>
              <Text style={styles.headerLabel}>PRENOM : </Text>
              <Text style={styles.headerValue}>{member.firstName}</Text>
            </View>
            <View style={styles.headerLine}>
              <Text style={styles.headerLabel}>NUMERO MEMBRES : </Text>
              <Text style={styles.headerValue}>{member.matricule}</Text>
            </View>
            <View style={styles.headerLine}>
              <Text style={styles.headerLabel}>N * CNI/PASSEPORT : </Text>
              <Text style={styles.headerValue}>{member.identityDocumentNumber}</Text>
            </View>
            <View style={styles.headerLine}>
              <Text style={styles.headerLabel}>TEL : </Text>
              <Text style={styles.headerValue}>
                {member.contacts?.[0] || '—'}{member.contacts?.[1] ? ` / ${member.contacts[1]}` : ''}
              </Text>
            </View>
          </View>
        </View>
      ...
      <Page size="A4" style={styles.page}>
        ...
        <Text style={styles.checkbox}>☐ Exceptionnel</Text>
        <Text style={styles.checkbox}>☐ Régulier</Text>
      ...
      {/* PAGE 5 - SUITE ACTE DE CAUTIONNEMENT */}
      <Page size="A4" style={styles.page}>
        <Text style={styles.paragraph}>
...
export default CreditSpecialeContractPDF
