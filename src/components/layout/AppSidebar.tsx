...
export function AppSidebar() {
  ...
  return (
    <Sidebar className="border-r border-[#1A3D4F] bg-[#234D65] shadow-sm">
      <SidebarHeader className="flex h-20 justify-center border-b border-white/10 bg-[#234D65]">
                    ...
                    <SidebarMenuItem key={item.title}>
                      <SidebarMenuButton asChild>
                        <Link
                          href={item.url}
                          className={cn(
                            "group flex items-center gap-3 rounded-lg px-3 py-3 text-white/80 transition-colors duration-200 hover:bg-white/10 hover:text-white",
                        ...
                        >
                          <item.icon
                            className={cn(
                              "h-5 w-5 transition-colors duration-200 group-hover:text-[#CBB171]",
                              isActive && "text-[#CBB171]",
                            )}
                          />
                          <span
                            className={cn(
                ...
                return (
                  <SidebarMenuItem key={item.title}>
                    <button
                      ...
                      className={cn(
                        "flex w-full items-center justify-between gap-3 rounded-lg px-3 py-3 text-white/80 transition-colors duration-200 hover:bg-white/10 hover:text-white",
                        isSectionActive && "bg-white/15 text-white",
                      )}
                      style={{
                        animationDelay: `${index * 0.1}s`,
                      }}
                        ...
                        {item.children.map((child) => {
                          ...
                          return (
                            <Link
                              ...
                              href={child.url}
                              className={cn(
                                "flex items-center gap-2 rounded-lg px-3 py-2 text-xs text-white/70 transition-colors duration-200 hover:bg-white/10 hover:text-white",
                                isActive && "bg-white/15 text-white",
                              )}
                            >
      ...
      <SidebarFooter className="border-t border-white/10 bg-[#234D65] p-4">
        <div className="space-y-4">
          <div className="flex items-center gap-3 rounded-xl bg-white/5 p-3">
            <Avatar className="h-10 w-10 ring-2 ring-white/20">
              <AvatarImage src="/api/placeholder/32/32" alt="Admin" />
              <AvatarFallback className="bg-[#CBB171] text-sm font-bold text-white">
                AD
              </AvatarFallback>
            </Avatar>
            <div className="grid flex-1 text-left text-sm leading-tight">
          ...
          <Button
            variant="ghost"
            className="group w-full justify-start rounded-lg border border-red-400/20 text-red-200 transition-colors duration-200 hover:border-red-400/50 hover:bg-red-500/20 hover:text-red-100"
