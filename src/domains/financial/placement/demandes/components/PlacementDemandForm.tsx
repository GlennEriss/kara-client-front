...
import type { PlacementDemandFormInput } from '@/schemas/placement.schema'

export interface PlacementDemandFormProps {
  form: UseFormReturn<PlacementDemandFormInput>
  onSubmit: (data: PlacementDemandFormInput) => void | Promise<void>
  onCancel: () => void
  isPending?: boolean
  submitLabel?: string
  cancelLabel?: string
...
export function PlacementDemandForm({
  form,
  onSubmit,
  onCancel,
  isPending = false,
  ...
  const hasBenefactor = !!form.watch('benefactorId')
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        ...
        <Card>
          <CardContent className="pt-6 space-y-4">
            ...
            <div className="space-y-2">
              <FormLabel>Rechercher un bienfaiteur</FormLabel>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>Minimum: 1 000 FCFA</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>Entre 1 et 7 mois</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
        ...
        <div className="flex justify-end gap-3">
          ...
          <Button
            type="submit"
            disabled={isPending || !hasBenefactor}
