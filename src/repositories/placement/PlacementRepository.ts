  ...
  async getAll(opts: { statuses?: Placement['status'][]; payoutMode?: Placement['payoutMode'] } = {}): Promise<Placement[]> {
    ...
    return snaps.docs.map(docSnap => {
      ...
      return {
        ...
        handoverDate: d.handoverDate?.toDate ? d.handoverDate.toDate() : d.handoverDate,
        capitalRepaidAt: d.capitalRepaidAt?.toDate ? d.capitalRepaidAt.toDate() : d.capitalRepaidAt,
