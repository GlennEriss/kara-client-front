...
| [SEQ_FiltrerContrats.puml](./SEQ_FiltrerContrats.puml) | Filtres actifs + pagination | FiltrerContrats.puml | C.4 |
| [SEQ_RechercherContrats.puml](./SEQ_RechercherContrats.puml) | Recherche Firestore + filtres actifs + pagination | RechercherContrats.puml | C.2, C.3 |
