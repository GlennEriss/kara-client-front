...
- **Intérêts pendant le mois de repos lui-même :** **Option A retenue** : pas d’intérêts pendant le repos (le capital ne bouge pas). Tout ce qui était dû au mois mis au repos est reporté au mois suivant ; à la prochaine échéance on doit donc toujours le même capital. Voir [SIMULATION_EXEMPLE.md](./SIMULATION_EXEMPLE.md) §0 et §9.
